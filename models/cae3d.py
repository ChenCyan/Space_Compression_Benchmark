...
def cae3d_cr004(src_channels=202):
    return ConvolutionalAutoencoder3D(src_channels=src_channels, latent_channels=64)


def cae3d_cr008(src_channels=202):
    return ConvolutionalAutoencoder3D(src_channels=src_channels, latent_channels=32)


def cae3d_cr016(src_channels=202):
    return ConvolutionalAutoencoder3D(src_channels=src_channels, latent_channels=16)


def cae3d_cr032(src_channels=202):
    return ConvolutionalAutoencoder3D(src_channels=src_channels, latent_channels=8)


def cae3d_cr051(src_channels=202):
    return ConvolutionalAutoencoder3D(src_channels=src_channels, latent_channels=5)


def cae3d_cr064(src_channels=202):
    return ConvolutionalAutoencoder3D(src_channels=src_channels, latent_channels=4)


def cae3d_cr127(src_channels=202):
    return ConvolutionalAutoencoder3D(src_channels=src_channels, latent_channels=2)


def cae3d_cr253(src_channels=202):
    return ConvolutionalAutoencoder3D(src_channels=src_channels, latent_channels=1)
