...
def hycot_cr004(src_channels=202):
...
def hycot_cr008(src_channels=202):
    return HyperspectralCompressionTransformer(
        src_channels=src_channels,
...
def hycot_cr016(src_channels=202):
    return HyperspectralCompressionTransformer(
        src_channels=src_channels,
...
def hycot_cr032(src_channels=202):
    return HyperspectralCompressionTransformer(
        src_channels=src_channels,
...
def hycot_cr064(src_channels=202):
    return HyperspectralCompressionTransformer(
        src_channels=src_channels,
        target_compression_ratio=64,
        patch_depth=4,
    )


def hycot_cr128(src_channels=202):
    return HyperspectralCompressionTransformer(
        src_channels=src_channels,
        target_compression_ratio=128,
        patch_depth=4,
    )


def hycot_cr256(src_channels=202):
    return HyperspectralCompressionTransformer(
        src_channels=src_channels,
        target_compression_ratio=256,
        patch_depth=4,
    )


def hycot_cr512(src_channels=202):
    return HyperspectralCompressionTransformer(
        src_channels=src_channels,
        target_compression_ratio=512,
        patch_depth=4,
    )
